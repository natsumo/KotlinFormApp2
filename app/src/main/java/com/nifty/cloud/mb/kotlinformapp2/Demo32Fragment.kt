...
class Demo32Fragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        if (mView == null) {
            ...
            val spinnerAgeGreaterThan = mView!!.findViewById<View>(R.id.spinnerAgeGreaterThan) as Spinner
            val spinnerAgeLessThan = mView!!.findViewById<View>(R.id.spinnerAgeLessThan) as Spinner
            val btnSearch = mView!!.findViewById<View>(R.id.btnSearch) as Button
